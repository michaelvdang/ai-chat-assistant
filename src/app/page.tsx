  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-between p-24">
      <div className="z-10 w-full max-w-5xl items-center justify-between font-mono text-sm lg:flex">
        ...
        bg-gradient-to-b from-zinc-200 pb-6 pt-8 backdrop-blur-lg dark:border-neutral-800 
      ...
      {/* <div>
        <div className="columns-2 bg-gradient-to-r from-teal-400 to-blue-500 hover:from-pink-500 hover:to-orange-500">
      ...
      before:w-full before:-translate-x-1/4 before:blur-3xl before:rounded-full before:bg-gradient-radial 
      before:from-blue-700 before:to-red-500 before:content-[''] after:absolute 
      after:-z-20 after:h-[180px] after:w-full after:translate-x-1/3 after:bg-gradient-conic 
